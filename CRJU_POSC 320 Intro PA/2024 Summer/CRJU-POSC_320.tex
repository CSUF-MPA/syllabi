...
\fancypagestyle{firstpage}{
  \fancyhf{}
  \fancyhead[C]{\includegraphics[width=8cm]{/Volumes/SamsungSSD/Nextcloud/Syllabi/Images/stacked.png}}
  \fancyfoot[C]{\thepage}
}
...
\title{\includegraphics[width=8cm]{/Volumes/SamsungSSD/Nextcloud/Syllabi/Images/stacked.png} \\\textbf{Introduction to Public Administration}}
