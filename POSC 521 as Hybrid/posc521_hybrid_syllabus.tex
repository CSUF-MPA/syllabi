...
\begin{itemize}
    ...
    \item Readings:
    \begin{itemize}
        \item \cite{brown2016} % Add this entry to your bibliography file
         \item \cite{Cohen2008} % Add this entry to your bibliography file
         \item \cite{Hefetz2014} % Add this entry to your bibliography file
         \item \cite{jos2009} % Add this entry to your bibliography file
         \item \cite{lamothe2012} % Add this entry to your bibliography file
    \end{itemize}   
    \item Due: Annotated Bibliography, Synthesis, and Personal Reflection
\end{itemize}
