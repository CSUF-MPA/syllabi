...
The due dates for the course requirements are as follows:
    \begin{itemize}
        \item Book Report or Annotated Bibliography and Synthesis: 
        \begin{itemize}
            \item Due each week by 6:59 p.m. on Thursday
            \item Personal Reflection: Due each week by 11:59 p.m. on Sunday
        \end{itemize}Due each week by 6:59 p.m. on Thursday
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Cicero (44), \emph{On Duties} \cite{newton2016}
            \item Wilson, ``The Study of Administration'' \cite{Wilson1887}
            \item Weber, ``Bureaucracy'' \cite{Weber1946}
            \item Gulick, ``Notes on the Theory of Organization'' \cite{gulick1937}
            \item Follett, ``The Giving of Orders'' \cite{Follett1926}
            \item Simon, ``Proverbs of Administration'' \cite{simon1946a}
        \end{itemize}
    \item Due Thursday: Annotated Bibliography and Synthesis
    \item Due Saturday: Personal Reflection
\end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Stivers, \emph{Bureau Men, Settlement Women} \cite{Stivers2000}
            \item Denhardt and Denhardt, \emph{The New Public Service}, Chapters 1--4 \cite{Denhardt2015}
        \end{itemize}
    \item Due Thursday: Annotated Bibliography and Synthesis
    \item Due Saturday: Personal Reflection
\end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Friedrich, ``Responsible Government Service Under the American Constitution'' \cite{friedrich1935}
            \item Finer, ``Administrative Responsibility in Democratic Government'' \cite{FINER1941}
            \item Goss, ``A Distinct Public Administration Ethics?'' \cite{goss1996}
            \item Adams, ``Unmasking Administrative Evil'' \cite{Adams2009}
            \item Denhardt, \emph{The New Public Service}, Chapter 7 \cite{Denhardt2015}
        \end{itemize}
    \item Due Thursday: Annotated Bibliography and Synthesis
    \item Due Saturday: Personal Reflection
\end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Christensen, ``Public Service Motivation Research'' \cite{Christensen2017}
            \item Denhardt, \emph{The New Public Service}, Chapter 8 \cite{Denhardt2015}
            \item Lachance, ``Public Service Motivation'' \cite{Lachance2017}
            \item Maslow, ``A Theory of Human Motivation'' \cite{maslow1943}
            \item Fairholm, ``Different Perspectives on the Practice of Leadership'' \cite{Fairholm2004}
        \end{itemize}
    \item Due Thursday: Annotated Bibliography and Synthesis
    \item Due Saturday: Personal Reflection
\end{itemize}

\subsection*{Week 5 -- 9/26: Street-Level Bureaucrats}
\begin{itemize}
    \item \textbf{In-person Session}: Street-Level Bureaucrats
    \item Readings:
        \begin{itemize}
            \item Lipsky, \emph{Street-Level Bureaucracy}, Chapters 1--10 \cite{Lipsky2010}
            \item Denhardt, \emph{The New Public Service}, Chapters 5--6 \cite{Denhardt2015}
        \end{itemize}
    \item Due Thursday: Book Report
    \item Due Saturday: Personal Reflection
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Behn, ``Why Measure Performance?'' \cite{Behn2003}
            \item Denhardt, \emph{The New Public Service}, Chapter 9 \cite{Denhardt2015}
            \item Douglas, ``Getting a Grip on Performance of Collaborations'' \cite{douglas2021}
            \item Marvel, ``Unconscious Bias in Citizens' Evaluations\dots'' \cite{marvel2015}
            \item Nicholson-Crotty, ``Public Management and Organizational Performance'' \cite{nicholson-crotty2004}
        \end{itemize}
    \item Due Thursday: Book Report
    \item Due Saturday: Personal Reflection
\end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Cohen, ``Privatization'' \cite{Cohen2008}
            \item Jos, ``Keeping it Public'' \cite{jos2009}
        \end{itemize}
    \item Due Thursday: Book Report
    \item Due Saturday: Personal Reflection
\end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        \begin{itemize}
            \item Maynard-Moody, ``Social Equities and Inequities in Practice'' \cite{maynard-moody2012}
            \item Gooden, ``Social Equity and Evidence'' \cite{GOODEN2017}
            \item McCandless, ``A Long Road'' \cite{mccandless2022}
            \item Denhardt, \emph{The New Public Service}, Chapters 10--12 \cite{Denhardt2015}
        \end{itemize}
    \item Due Thursday: Book Report
    \item Due Saturday: Personal Reflection
\end{itemize}
