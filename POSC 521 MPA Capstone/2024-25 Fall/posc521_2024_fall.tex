...
\date{Thursdays at 7:00 in GH 248}
    ...
    \begin{tabular}{|>{\raggedright}m{4cm}|>{\raggedright\arraybackslash}m{10cm}|}
        \hline
        \textbf{In-Person Sessions:} & August 29; September 5, 12, 19, 26; October 3, 10, 17; November 14; December 12. \\
        \hline
        \textbf{Asynchronous Online Sessions:} & October 24, 31; November 7, 28; December 5, 19. \\
        \hline
    \end{tabular}
...
To facilitate class discussion and prepare you for comprehensive exams, your weekly writing assignment begins with an annotated bibliography of each weekly reading. It concludes with a 2- to 3-page synthesis of the week's readings. This assignment incorporates a group activity using an AI large language model (ChatGPT) and individual work.
...
\textbf{Reflection}: A reflection is a metacognitive practice that allows you to analyze your learning process, the feedback you've received, and the evolution of your understanding of the week's topic. The reflection should consider how your understanding of the readings evolved, which feedback was most beneficial, how the peer review process impacted your perspective, what strategies were most effective, and how you can apply the lessons from the assignment to future tasks in public administration or other professional settings.

The reflection is an optional activity and will be graded as a bonus point assignment. It is an opportunity for you to engage in self-assessment and continuous improvement, enhancing your learning and professional development.

\subsubsection*{Details}

\textbf{Instructions}: Your weekly writing assignment begins with an annotated bibliography of each weekly reading to facilitate class discussion and prepare you for comprehensive exams. It concludes with a 2-page synthesis of the week's readings. This assignment incorporates a group activity, the use of an AI large language model (e.g., ChatGPT, Claude, etc.), and individual work.
...
\begin{enumerate}
    \item \textbf{Purpose}: Review the literature on the week's topic, preparing you for an in-depth synthesis and class discussion. 
    ...
    \begin{itemize}
        \item \textbf{Citation}: Provide a full citation for the source in APA or Chicago author-date style.
        \item \textbf{Summary}: Summarize the central theme and key points of the source in your own words.
...
\begin{itemize}
    ...
    \item \textbf{Process}: You will write a 2- to 3-page synthesis of the week's readings each week. The synthesis should not be a simple summary of each source but rather a critical analysis that identifies patterns, draws connections, and addresses contradictions among the sources. The synthesis encourages you to think critically and analytically about the readings and their implications for the theory and practice of public administration.
        \begin{itemize}
            \item Upon completion, submit your draft to Canvas for peer review. Canvas will automatically assign two peers to review for each student. Read your peer's synthesis and use the rubric on \emph{Canvas}. The rubric is only a guide, so feel free to provide additional feedback as you see fit, and don't feel obligated to comment on every criterion. Be kind, constructive, and specific in your feedback. 
            ...
            \item You do not need to revise your synthesis based on the AI's feedback. The AI feedback is for your benefit only and will not be graded.
            \item Submit your revised synthesis \emph{and} the AI's feedback to Canvas for grading.
        \end{itemize}
    \item \textbf{Grading}: The synthesis will be graded based on a Canvas rubric. The peer review will be graded based on the quality of the feedback provided. The synthesis, peer review, and AI feedback will be graded as a single assignment according to the following weights:
        \begin{itemize}
            ...
            \item AI Feedback: 10\%
        \end{itemize}
    Your revised synthesis will be scored using the rubric on \emph{Canvas}. 
\end{itemize}

\textbf{3. Bonus Point Refection Activity}
    \begin{itemize}
...
The due dates for the course requirements are as follows:
    \begin{itemize}
        ...
        \begin{itemize}
            \item Due each week by 6:59 p.m. on Thursday
            \item Personal Reflection: Due each week by 11:59 p.m. on Sunday
        \end{itemize}
...
\begin{itemize}
    ...
    \item Readings:
        ...
        \end{itemize}
    \item Due Thursday: Annotated Bibliography and Synthesis
    \item Due Sunday: Personal Reflection
\end{itemize}
